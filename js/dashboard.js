...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const projectData =
        ...
        (typeof landTrackProjects !== "undefined"
            ? landTrackProjects
            : []);
    ...
    function getRiskColor(score) {
        ...
        if (score >= 80) return "#b94a48";

        if (score >= 65) return "#c8872b";

        if (score >= 50) return "#b49a43";
